...
async def cmd_start(message: Message) -> None:
    ...
    await message.answer(
        "💰 <b>My Cash — личный финансовый помощник</b>\n\n"
        "Просто напиши что потратила — я сам определю категорию и сохраню:\n"
        "<i>«такси 3000»</i>, <i>«продукты 15000»</i>, <i>«зарплата 200000»</i>\n\n"
        "🎤 Голосовые сообщения — скажи и готово\n"
        "✅ Автокатегоризация через ИИ\n"
        "✅ KZT, UZS, USD — автоконвертация по актуальному курсу\n"
        "✅ Баланс на руках после каждой записи\n"
        "✅ Отчёты: сегодня, неделя, месяц\n"
        "✅ Графики трат по категориям\n"
        "✅ Редактирование и отмена записей\n\n"
        "Начинай — просто напиши первый расход 👇",
        parse_mode="HTML",

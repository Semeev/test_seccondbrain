...
- [[files/Партнёр_Google_таблица_2026-08-22.xlsx|Таблица партнёра — версия 1]]
- [[files/Партнёр_Google_таблица_2026-08-22_v2.xlsx|Таблица партнёра — версия 2 (другие цифры по тем же датам)]]
- [[files/Свод_Самарканд_доход_расход_окупаемость.xlsx|Итоговый сводный Excel: доход, расходы, окупаемость]]
- [[files/Даты_для_сверки_с_Google_календарём.xlsx|Чек-лист дат для сверки с Google-календарём партнёра]]
